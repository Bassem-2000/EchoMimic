...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='EchoMimic Inference')
    parser.add_argument('--image_path', type=str, required=True, help='Path to the reference image')
    parser.add_argument('--audio_path', type=str, required=True, help='Path to the input audio')
    parser.add_argument('--width', type=int, default=default_values["width"], help='Video width')
    parser.add_argument('--height', type=int, default=default_values["height"], help='Video height')
    parser.add_argument('--length', type=int, default=default_values["length"], help='Video length')
    parser.add_argument('--seed', type=int, default=default_values["seed"], help='Random seed')
    parser.add_argument('--facemask_dilation_ratio', type=float, default=default_values["facemask_dilation_ratio"], help='Facemask dilation ratio')
    parser.add_argument('--facecrop_dilation_ratio', type=float, default=default_values["facecrop_dilation_ratio"], help='Facecrop dilation ratio')
    parser.add_argument('--context_frames', type=int, default=default_values["context_frames"], help='Context frames')
    parser.add_argument('--context_overlap', type=int, default=default_values["context_overlap"], help='Context overlap')
    parser.add_argument('--cfg', type=float, default=default_values["cfg"], help='CFG (Classifier-Free Guidance) scale')
    parser.add_argument('--steps', type=int, default=default_values["steps"], help='Number of inference steps')
    parser.add_argument('--sample_rate', type=int, default=default_values["sample_rate"], help='Audio sample rate')
    parser.add_argument('--fps', type=int, default=default_values["fps"], help='Frames per second for the output video')
    parser.add_argument('--device', type=str, choices=['cuda', 'cpu'], default=default_values["device"], help='Device to use')
    ...
    final_video_path = process_video(
        ...
        args.length, 
        args.seed, 
        args.facemask_dilation_ratio, 
        args.facecrop_dilation_ratio, 
        args.context_frames, 
        args.context_overlap, 
        args.cfg, 
        args.steps, 
        args.sample_rate, 
        args.fps, 
